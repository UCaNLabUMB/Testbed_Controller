...
class Tx_Tone_HackRF(gr.top_block):
    ...
    def __init__(self, fc=int(915e6), node='101', samp_rate=3e6, tone_amp=0.02, tone_freq=500e3, tx_gain=40):
        ...
        self.soapy_hackrf_sink_0.set_frequency(0, fc)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.soapy_hackrf_sink_0.set_frequency(0, self.fc)
...
def main(top_block_cls=Tx_Tone_HackRF, options=None):
    if options is None:
