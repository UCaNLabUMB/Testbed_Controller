...
class Rx_general_HackRF(gr.top_block):
    ...
    def __init__(self, fc=915000000, node='101', rx_gain=40, samp_rate=3000000):
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_float, 1, "tcp://10.1.1."+node+":55555", 100, False, 1, '', True, True)
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(rx_gain, 0.0), 62.0))
    ...
    def set_rx_gain(self, rx_gain):
        self.rx_gain = rx_gain
        self.soapy_hackrf_source_0.set_gain(0, 'VGA', min(max(self.rx_gain, 0.0), 62.0))
...
def main(top_block_cls=Rx_general_HackRF, options=None):
    if options is None:
