...
class Rx_general_Pluto(gr.top_block):
    ...
    def __init__(self, fc=915000000, node='101', rx_gain=40, samp_rate=3000000):
        ...
        self.iio_pluto_source_0 = iio.fmcomms2_source_fc32('ip:192.168.2.1' if 'ip:192.168.2.1' else iio.get_pluto_uri(), [True, True], 16384)
...
def argument_parser():
    ...
    parser.add_argument(
        "-a", "--samp-rate", dest="samp_rate", type=intx, default=3000000,
        help="Set Sample Rate [default=%(default)r]")
    return parser


def main(top_block_cls=Rx_general_Pluto, options=None):
    if options is None:
