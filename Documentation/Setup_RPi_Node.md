...
* Regenerate SSH Keys (i.e., follow [Control Network Configuration](https://github.com/UCaNLabUMB/Testbed_Controller/blob/main/Documentation/Config_Control_Net.md)) and run `sudo rm /etc/ssh/ssh_host_*`, 
* Reboot to securely generate new, unique encryption keys. 
* Update eth0 IP Address (i.e., follow the instructions for RPi Node Configuration above) for the correct network address of the specific node of interest.
